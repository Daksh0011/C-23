...
function setup() {
	...
	ground = Bodies.rectangle(width/2, 650, 6, 10 , {isStatic:true} );
	 ...
	 g1 = Bodies.rectangle(width/2, 650, 6, 10 , {isStatic:true});
	 World.add(world, g1);

	 g2 = Bodies.rectangle(g2Sprite.position.x,g2Sprite.position.y, 10, 6 , {isStatic:true});
 	World.add(world, g2);
	
	 g3 = Bodies.rectangle(g3Sprite.position.x,g3Sprite.position.y, 10, 6 , {isStatic:true});
 	World.add(world, g3);
